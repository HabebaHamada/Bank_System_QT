...
Client::Client():activerequest(nullptr) {
    ...
    socket.connectToHost("192.168.1.9", 22);
}
...
void Client::View_Account_Balance(QString Account_Number)
{
    ...
    // Create a JSON object
    QJsonObject jsonObject;
    jsonObject["Accountnumber"] =  (Account_Number);
    QJsonDocument jsonDocument(jsonObject);
...
void Client::Make_Transaction(QString accountnumber,int32_t transactionamount)
{
...
void Client::Transfer_Amount(QString fromaccountnumber,QString toaccountnumber,int32_t transactionamount)
{
    ...
    // Create a JSON object
    QJsonObject jsonObject;
    jsonObject["fromaccountnumber"] =  (fromaccountnumber);
    jsonObject["toaccountnumber"] =    (toaccountnumber);
    jsonObject["transactionamount"] = transactionamount;
    QJsonDocument jsonDocument(jsonObject);
